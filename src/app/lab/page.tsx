...
export default function LabPage() {
  ...
  ]} posts={[]} postsTitle="Current experiments" emptyTitle="The first public experiment is being designed" emptyText="It will be published only after the hypothesis, rules, data, costs, and stop conditions are fixed in advance." ctaLabel="Learn the method" ctaHref="/vibe-trading" />;
}
