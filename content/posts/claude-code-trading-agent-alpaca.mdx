---
title: "Build a 24/7 AI Trading Agent with Claude Code and Alpaca"
description: "Step-by-step tutorial to build an autonomous trading agent using Claude Code Routines and the Alpaca API. Includes complete code, guardrails, and deployment tips."
date: "2026-07-03"
category: "Tutorials"
tags: ["claude code", "alpaca", "ai trading agent", "python", "tutorial"]
...
If you want a structured checklist and starter templates, download the [AI Trading Starter Kit](/starter-kit).
