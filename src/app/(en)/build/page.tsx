...
export default function BuildPage() {
  ...
  return <HubPage eyebrow="Build" title="From a sentence to something you can test." description="Start with a market idea in plain English. Build the smallest useful workflow, make every rule visible, and add complexity only when the evidence justifies it." principles={["No-code to developer", "Copyable steps", "Guardrails included"]} cards={[
    { eyebrow: "Level 01", title: "No-code workflows", description: "Research prompts, checklists, spreadsheets, and tools that work without programming.", href: "/blog?tag=beginners" },
    { eyebrow: "Level 02", title: "Low-code builds", description: "TradingView scripts and small automations generated with AI and explained line by line.", href: "/tutorials" },
    { eyebrow: "Level 03", title: "Python and APIs", description: "Market data, backtesting, broker APIs, logs, alerts, and explicit risk controls.", href: "/blog?tag=python" },
    { eyebrow: "Level 04", title: "Trading agents", description: "Research and execution agents with structured decisions, permissions, and kill switches.", href: "/blog?tag=multi-agent" },
