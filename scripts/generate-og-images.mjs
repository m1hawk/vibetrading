...
const staticPages = [
  ...
  { key: "tools-bitcoin-up-or-down", lang: "en", category: "Free Data Tool", title: "Bitcoin Up or Down: Historical Daily Data", description: "How often does Bitcoin actually go up in a day? One year of daily up/down results, streaks, and monthly stats." },
  { key: "tools-elon-musk-tweets", lang: "en", category: "Free Data Tool", title: "Elon Musk Tweet Count: Weekly Historical Data", description: "Weekly tweet counts reconstructed from settled Polymarket bracket markets. Ranges, trends, and live bracket odds." },
  ...
  { key: "zh/tools-bitcoin-up-or-down", lang: "zh", category: "免费数据工具", title: "比特币猜涨跌：每日历史数据", description: "比特币一天之内到底涨多还是跌多？过去一年的每日涨跌记录、连涨连跌和逐月统计。" },
  { key: "zh/tools-elon-musk-tweets", lang: "zh", category: "免费数据工具", title: "Elon Musk 每周发帖数：历史数据", description: "从 Polymarket 已结算区间市场还原的每周发帖数量。区间、趋势和当前市场赔率。" },
