...
- [ ] Phase 0：分支创建 + 基线构建 + 删除清单确认
- [ ] P1：4 类分类收敛、空壳页删除、`/lab` 动态化、页脚补 Tutorials
- [ ] P2：145 张 OG 图生成并接入 metadata、PostCard 缩略图上线
- [ ] P3：署名/更新时间/相关阅读/进度条/上下篇全部上线
- [ ] P4：`lang="zh-CN"` 生效、字体自托管、中文标题字形正确
- [ ] P5：对比度达标、focus-visible、文案与内容红线对齐
- [ ] 部署 + sitemap 重提 + Removals 提交 + 一周 Coverage 观察
